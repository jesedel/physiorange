            ...
            <div class="bg-white">
                <div class="max-w-2xl mx-auto pt-16 pb-24 px-4 sm:pt-24 sm:pb-32 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
                    ...
                    <div class="lg:max-w-lg lg:self-end">
                        ...
                        <div class="mt-4">
                            <h1 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Starte durch, miete dich ein.</h1>
                        </div>
                    ...
                    <div class="mt-10 lg:mt-0 lg:col-start-2 lg:row-span-2 lg:self-center">
                        <div class="aspect-w-1 aspect-h-1 rounded-lg overflow-hidden">
                            <img src="/images/lukas.png" alt="Lukas Gennrich" class="object-center object-cover mx-auto">
                        </div>
                    </div>
